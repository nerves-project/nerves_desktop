This is a desktop application written using Tauri and the Phoenix web framework.
...
- Commit messages should only be **ONE LINE** and be short and concise. Never
  add "Co-authored by" or "Signed off by" tags in the commit body.
- Minimize the number of comments in the code, and remove/refactor existing
  superfluous comments. Comments should be one line or less and serve only to
  clarify a decision or use of a variable name. No comments in markup or data
  files
- Use the tidewave plugin for searching Elixir docs, running code in the project
  context, and more.
- Prioritize correctness and simplicity. Use the superpowers skills to plan and
  write specs for the project. Do not include plans or specs in the project repo
