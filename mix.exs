defmodule NervesDesktop.MixProject do
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind nerves_desktop", "esbuild nerves_desktop"],
      "assets.deploy": [
        "tailwind nerves_desktop --minify",
        "esbuild nerves_desktop --minify",
        "phx.digest"
      ],
